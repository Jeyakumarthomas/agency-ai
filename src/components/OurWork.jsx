...
const OurWork = () => {
  ...
  return (
    <div id="our-work" className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24
    xl:px-40 pt-30 text-gray-700 dark:text-white' > 

    <Title title='Our latest work' desc='From stratigy to execution,we craft digital solutions that moves your business forword.'/>
